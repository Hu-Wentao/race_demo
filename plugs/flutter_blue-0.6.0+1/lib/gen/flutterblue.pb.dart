...
class RequestMtuRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('RequestMtuRequest')
    ..aOS(1, 'remoteId')
    ..a(2, 'mtuSize', $pb.PbFieldType.O3)
    ..aOB(3, 'success')
    ..hasRequiredFields = false
  ;

  RequestMtuRequest() : super();
  RequestMtuRequest.fromBuffer($core.List i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RequestMtuRequest.fromJson( $core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class RequestConnectionPriorityRequest extends $pb.GeneratedMessage {
  ...
  RequestConnectionPriorityRequest.fromBuffer($core.List i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  RequestConnectionPriorityRequest.fromJson( $core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
